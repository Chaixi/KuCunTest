...
{
    public partial class DJCL : Form
    {
        ...
        private void DJCL_Load(object sender, EventArgs e)
        {
        ...
        private void BindRoot()
        {
            ...
            //把数据库中取出所有所在设备名称
            SqlStr = "select distinct szsb from daoju order by szsb desc";
            MySqlDataReader szsb = SQL.getcom(SqlStr);
